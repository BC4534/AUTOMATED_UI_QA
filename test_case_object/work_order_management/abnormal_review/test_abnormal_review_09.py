...
class TestAbnormalReview09:
    ...
    def test_abnormal_review_09_01(self, login_driver):
        ...
        try:
            ...
            second_work_order_number = abnormal_details_page.get_second_work_order_number()
            ...
            if second_work_order_number != 1:
                assert abnormal_details_page.get_first_work_order_number() == second_work_order_number
    ...
    def test_abnormal_review_09_02(self, login_driver):
        ...
        try:
            ...
            abnormal_details_page.click_search_button()
            if abnormal_name != 1:
                assert   abnormal_name in abnormal_details_page.get_first_work_order_abnormal_name()
            logger.info(f"{self.__class__.__name__}执行用例成功")
        except Exception as e:
            logger.error(f"{self.__class__.__name__}执行用例失败,错误信息为:{e}")
            abnormal_details_page.get_screenshot_png(f"{self.__class__.__name__}")
    ...
    def test_abnormal_review_09_03(self, login_driver):
        ...
        try:
            ...
            abnormal_details_page.click_search_button()
            if project != 1:
                assert project in abnormal_details_page.get_first_work_order_relation_project()
            logger.info(f"{self.__class__.__name__}执行用例成功")
        except Exception as e:
            logger.error(f"{self.__class__.__name__}执行用例失败,错误信息为:{e}")
            abnormal_details_page.get_screenshot_png(f"{self.__class__.__name__}")
    ...
    def test_abnormal_review_09_04(self, login_driver):
        ...
        try:
            ...
            abnormal_details_page.click_search_button()
            type1 = abnormal_details_page.get_first_work_order_relation_work_order_type()
            if type1 != 1:
                assert type1 == "手工异常工单"
            abnormal_details_page.switch_to_abnormal_details_page()
            abnormal_details_page.click_reset_button()
            ...
            abnormal_details_page.click_search_button()
            type2 = abnormal_details_page.get_first_work_order_relation_work_order_type()
            if type2 != 1:
                assert type2 == "系统异常工单"
            abnormal_details_page.switch_to_abnormal_details_page()
            logger.info(f"{self.__class__.__name__}执行用例成功")
    ...
    def test_abnormal_review_09_05(self, login_driver):
        ...
        try:
            ...
            abnormal_details_page.click_search_button()
            if abnormal_part != 1:
                assert abnormal_part == abnormal_details_page.get_first_work_order_abnormal_part()
            logger.info(f"{self.__class__.__name__}执行用例成功")
        except Exception as e:
            logger.error(f"{self.__class__.__name__}执行用例失败,错误信息为:{e}")
            abnormal_details_page.get_screenshot_png(f"{self.__class__.__name__}")
    ...
    def test_abnormal_review_09_06(self, login_driver):
        ...
        try:
            ...
            abnormal_details_page.click_search_button()
            if vendor != 1:
                assert vendor == abnormal_details_page.get_first_work_order_responsible_vendor()
            logger.info(f"{self.__class__.__name__}执行用例成功")
        except Exception as e:
            logger.error(f"{self.__class__.__name__}执行用例失败,错误信息为:{e}")
            abnormal_details_page.get_screenshot_png(f"{self.__class__.__name__}")
    ...
    def test_abnormal_review_09_07(self, login_driver):
        ...
        try:
            ...
            abnormal_details_page.switch_to_abnormal_details_page()
            abnormal_details_page.click_reset_button()
            person = abnormal_details_page.get_second_work_order_abnormal_processing_person()
            abnormal_details_page.select_abnormal_processing_person(person)
            abnormal_details_page.click_search_button()
            if person != 1:
                assert person == abnormal_details_page.get_first_work_order_abnormal_processing_person()
            logger.info(f"{self.__class__.__name__}执行用例成功")
