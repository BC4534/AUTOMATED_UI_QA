...
class TestAccountManagement15():
    """
    编辑功能，编辑后点取消，源数据不应该改
    """

    def test_account_management_15(self, login_driver):
        ...
        try:
            ...
            account_management_page.account_management_14(name=data2["name"],
            ...
            account_management_page.click_cancel_button()
