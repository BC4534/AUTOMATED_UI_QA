...
class TestOutdoorCabinetAlarmConfiguration05:
    ...
    def test_outdoor_cabinet_alarm_configuration_05_01(self, login_driver):
        ...
        try:
            ...
            assert (
                outdoor_cabinet_alarm_configuration_page.get_operation_alarm_type_required_message()
                == "请输入必填字段"
            )
    ...
    def test_outdoor_cabinet_alarm_configuration_05_02(self, login_driver):
        ...
        try:
            ...
            des = (
                outdoor_cabinet_alarm_configuration_page.get_edit_operation_alarm_description_content()
            )
