...
class TestOutdoorCabinetAlarmConfiguration06:
    ...
    def test_outdoor_cabinet_alarm_configuration_06_01(self, login_driver):
        ...
        try:
            ...
            second_device_name = (
                outdoor_cabinet_alarm_configuration_page.get_second_device_name()
            )
            outdoor_cabinet_alarm_configuration_page.input_device_name_search_condition(
                second_device_name
            )
            outdoor_cabinet_alarm_configuration_page.click_search_button()
            assert (
                outdoor_cabinet_alarm_configuration_page.get_first_device_name()
                == second_device_name
            )
    ...
    def test_outdoor_cabinet_alarm_configuration_06_02(self, login_driver):
        ...
        try:
            ...
            outdoor_cabinet_alarm_configuration_page.outdoor_cabinet_specification_search(
                outdoor_cabinet_specification="215户外柜国标1.0"
            )
            outdoor_cabinet_alarm_configuration_page.click_search_button()
            if (
                outdoor_cabinet_alarm_configuration_page.get_first_outdoor_cabinet_specification()
                != 1
            ):
                assert (
                    outdoor_cabinet_alarm_configuration_page.get_first_outdoor_cabinet_specification()
            ...
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            outdoor_cabinet_alarm_configuration_page.outdoor_cabinet_specification_search(
                outdoor_cabinet_specification="215户外柜国标2.0"
            )
            outdoor_cabinet_alarm_configuration_page.click_search_button()
            if (
                outdoor_cabinet_alarm_configuration_page.get_first_outdoor_cabinet_specification()
            ...
            logger.error(f"{self.__class__.__name__}执行用例失败，失败原因为：{e}")
            outdoor_cabinet_alarm_configuration_page.get_screenshot_png(
                "户外柜规格查询"
            )
            raise e
    ...
    def test_outdoor_cabinet_alarm_configuration_06_03(self, login_driver):
        ...
        try:
            ...
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            second_alarm_name = (
                outdoor_cabinet_alarm_configuration_page.get_second_alarm_name()
            )
            outdoor_cabinet_alarm_configuration_page.input_alarm_name_search_condition(
                second_alarm_name
            )
            outdoor_cabinet_alarm_configuration_page.click_search_button()
            assert (
                outdoor_cabinet_alarm_configuration_page.get_first_alarm_name()
                == second_alarm_name
            )
            logger.info(f"{self.__class__.__name__}执行用例成功")
        except Exception as e:
    ...
    def test_outdoor_cabinet_alarm_configuration_06_04(self, login_driver):
        ...
        try:
            ...
            outdoor_cabinet_alarm_configuration_page.switch_to_outdoor_cabinet_alarm_configuration_page()
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            second_alarm_description = (
                outdoor_cabinet_alarm_configuration_page.get_second_alarm_description()
            )
            outdoor_cabinet_alarm_configuration_page.input_alarm_description_search_condition(
                second_alarm_description
            )
            outdoor_cabinet_alarm_configuration_page.click_search_button()
            if (
                outdoor_cabinet_alarm_configuration_page.get_first_alarm_description()
                != 1
            ):
                assert (
                    outdoor_cabinet_alarm_configuration_page.get_first_alarm_description()
    ...
    def test_outdoor_cabinet_alarm_configuration_06_05(self, login_driver):
        ...
        try:
            ...
            outdoor_cabinet_alarm_configuration_page.switch_to_outdoor_cabinet_alarm_configuration_page()
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            outdoor_cabinet_alarm_configuration_page.input_alarm_type_search_condition(
                "EMS"
            )
            outdoor_cabinet_alarm_configuration_page.click_search_button()
            if outdoor_cabinet_alarm_configuration_page.get_first_alarm_type() != 1:
                assert (
                    outdoor_cabinet_alarm_configuration_page.get_first_alarm_type()
                    == "EMS"
                )
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            outdoor_cabinet_alarm_configuration_page.input_alarm_type_search_condition(
    ...
    def test_outdoor_cabinet_alarm_configuration_06_06(self, login_driver):
        ...
        try:
            ...
            outdoor_cabinet_alarm_configuration_page.switch_to_outdoor_cabinet_alarm_configuration_page()
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            outdoor_cabinet_alarm_configuration_page.input_alarm_is_alarm_search_condition(
                "是"
            )
            outdoor_cabinet_alarm_configuration_page.click_search_button()
            if outdoor_cabinet_alarm_configuration_page.get_first_alarm_level() != 1:
                assert (
                    outdoor_cabinet_alarm_configuration_page.get_first_alarm_is_alarm()
                    == "是"
                )
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            outdoor_cabinet_alarm_configuration_page.input_alarm_is_alarm_search_condition(
    ...
    def test_outdoor_cabinet_alarm_configuration_06_07(self, login_driver):
        ...
        try:
            ...
            outdoor_cabinet_alarm_configuration_page.switch_to_outdoor_cabinet_alarm_configuration_page()
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            outdoor_cabinet_alarm_configuration_page.input_alarm_is_auto_create_work_order_search_condition(
                "是"
            )
            outdoor_cabinet_alarm_configuration_page.click_search_button()
            if (
                outdoor_cabinet_alarm_configuration_page.get_first_alarm_is_auto_create_work_order()
                != 1
            ):
                assert (
                    outdoor_cabinet_alarm_configuration_page.get_first_alarm_is_alarm()
    ...
    def test_outdoor_cabinet_alarm_configuration_06_08(self, login_driver):
        ...
        try:
            ...
            outdoor_cabinet_alarm_configuration_page.click_reset_button()
            second_modified = (
                outdoor_cabinet_alarm_configuration_page.get_second_alarm_last_modifier()
            )
            if second_modified != 1:
                outdoor_cabinet_alarm_configuration_page.input_alarm_last_modifier_search_condition(
                    second_modified
                )
                outdoor_cabinet_alarm_configuration_page.click_search_button()
                if (
                    outdoor_cabinet_alarm_configuration_page.get_first_alarm_last_modifier()
                    != 1
                ):
                    assert (
                        outdoor_cabinet_alarm_configuration_page.get_first_alarm_last_modifier()
