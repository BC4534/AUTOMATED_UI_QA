...
@allure.story("电子档案功能")
@allure.title("详情")
class TestElectronicArchives07:

    @allure.description("点击项目详情按钮")
    def test_electronic_archives_07(self, login_driver):
        ...
        try:
            ...
            add_election_archives_page._click_project_detail_info()
            assert add_election_archives_page._get_project_detail_info_title() == "详情"
