...
@allure.story("电子档案功能")
@allure.title("新增项目-通过标签页进行切换页面")
@allure.description("新增项目-通过标签页进行切换页面，不受填写顺序影响")
class TestElectronicArchives05:

    def test_electronic_archives_05(self, login_driver):
        ...
        try:
            ...
            add_election_archives_page.test_electronic_archives_05()
            assert (add_election_archives_page.get_project_basic_info_title_status()
