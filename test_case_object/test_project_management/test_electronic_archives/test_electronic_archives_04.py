...
@allure.story("电子档案功能")
@allure.title("新增项目-新增项目-重名")
@allure.description("新增项目-项目名称不可以重复")
class TestElectronicArchives04:

    def test_electronic_archives_04(self, login_driver):
        ...
        try:
            ...
            assert add_election_archives_page.get_page_tip_text() == "项目名称不允许重复"
