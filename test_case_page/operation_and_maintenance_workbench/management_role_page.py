...
class ManagementRolePage(BasePage):
    ...
    def switch_to_management_role_page(self):
        ...
        if (
            self.get_operation_and_maintenance_workbench_basic_class()
            == "ant-menu-submenu ant-menu-submenu-inline ant-menu-submenu-selected"
        ):
            self.click_element(
                ManagementRoleLocator.operation_and_maintenance_workbench
            )
    ...
    def get_operation_and_maintenance_workbench_basic_class(self):
        return self.get_attribute(
            ManagementRoleLocator.operation_and_maintenance_workbench_basic_loc, "class"
        )
