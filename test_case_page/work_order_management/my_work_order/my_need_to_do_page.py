...
class MyNeedToDoPage(WorkOrderListPage):
    ...
    def input_work_order_number(self, work_order_number):
        self.send_keys_by_clear_and_typing(MyNeedToDoLocator.work_order_number_input_loc, work_order_number)
        self.random_sleep(0.5)
    ...
    def get_second_association_project(self):
        try:
            return self.text(MyNeedToDoLocator.second_work_order_association_project_loc)
        except:
    ...
    def is_close_work_order_detail_page_success(self):
        try:
            self.visibility_of_element_located(MyNeedToDoLocator.work_order_detail_mask_loc, 5, 1)
            return True
        except:
    ...
    def add_work_order_for_delete(self):
        ...
        self.test_work_order_list_02("巡检工单", "UI测试用于我的工单删除功能", "UI测试用于我的工单删除功能")
