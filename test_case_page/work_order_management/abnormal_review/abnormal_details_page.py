...
from test_case_locator.work_order_management.abnormal_review.abnormal_statistic_locator import AbnormalStatisticLocator
...
class AbnormalDetailsPage(BasePage):
    ...
    def _get_abnormal_details_is_active(self):
        return self.get_attribute(AbnormalDetailsLocator.abnormal_detail_class_loc, "class") == "ant-tabs-tab ant-tabs-tab-active"

    @allure.step("判断异常明细界面的异常统计部分是否展开")
    def _get_abnormal_statistic_is_expand(self):
        try:
            if self.visibility_of_element_located(AbnormalDetailsLocator.abnormal_statistic_expand_button_judge_loc):
                return True
    ...
    def click_first_work_order_attachment_button(self):
        try:
            self.click_element(AbnormalDetailsLocator.first_work_order_attachment_button_loc)
        except Exception as e:
    ...
    def _get_attachment_dialog_is_displayed(self):
        try:
            self.visibility_of_element_located(AbnormalDetailsLocator.attachment_dialog_title_loc)
            return True
        except Exception as e:
            return False
    ...
    def click_first_work_order_detail_button(self):
        try:
            self.click_element(AbnormalDetailsLocator.first_work_order_details_button_loc)
    ...
    def input_work_order_number(self, work_order_number):
        self.send_keys_by_clear_and_typing(AbnormalDetailsLocator.work_order_number_input_loc, work_order_number)
    ...
    def input_abnormal_name(self, abnormal_name):
        self.send_keys_by_clear_and_typing(AbnormalDetailsLocator.abnormal_name_input_loc, abnormal_name)
    ...
    def get_first_work_order_relation_project(self):
        try:
            return self.text(AbnormalDetailsLocator.first_work_order_relation_project_loc)
        except Exception as e:
    ...
    def get_second_work_order_relation_project(self):
        try:
            return self.text(AbnormalDetailsLocator.second_work_order_relation_project_loc)
        except Exception as e:
    ...
    def get_first_work_order_relation_work_order_type(self):
        try:
            self.click_element(AbnormalDetailsLocator.first_work_order_details_button_loc)
            return self.text(AbnormalDetailsLocator.first_work_order_relation_work_order_type_loc)
        except Exception as e:
    ...
    def get_first_work_order_responsible_vendor(self):
        try:
            return self.text(AbnormalDetailsLocator.first_work_order_responsible_vendor_loc)
        except Exception as e:
    ...
    def get_second_work_order_responsible_vendor(self):
        try:
            return self.text(AbnormalDetailsLocator.second_work_order_responsible_vendor_loc)
        except Exception as e:
    ...
    def get_first_work_order_is_purchase(self):
        try:
            self.click_element(AbnormalDetailsLocator.first_work_order_details_button_loc)
            self.random_sleep(1)
            self.click_element(AbnormalDetailsLocator.work_order_list_details_button_loc)
            self.random_sleep(1)
    ...
    def get_first_work_order_abnormal_processing_person(self):
        try:
            return self.text(AbnormalDetailsLocator.first_work_order_abnormal_processing_person_loc)
        except Exception as e:
    ...
    def get_second_work_order_abnormal_processing_person(self):
        try:
            return self.text(AbnormalDetailsLocator.second_work_order_abnormal_processing_person_loc)
        except Exception as e:
