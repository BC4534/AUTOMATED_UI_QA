...
class WorkOrderListPage(BasePage):
    ...
    def test_work_order_list_07_3(self, work_order_number):
        self.send_keys_by_clear_and_typing(WorkOrderListLocator.work_order_number_input_loc, work_order_number)
        time.sleep(0.5)
    ...
    def test_work_order_list_07_4(self, work_order_name):
        self.send_keys(WorkOrderListLocator.select_work_order_name_input_loc, work_order_name)
        time.sleep(0.5)
    ...
    def test_work_order_list_07_7(self, start_time,):
    ...
    def is_mask_dialog_exist(self):
        try:
            self.visibility_of_element_located(WorkOrderListLocator.manual_add_work_order_dialog_mask_loc, timeout=5,
                                               frequency=1)
            return True
        except:
            return False
