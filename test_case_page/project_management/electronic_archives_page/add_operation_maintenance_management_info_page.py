...
class AddOperationMaintenanceManagementInfoPage(AddMaintainImplementInfoManagementPage):
    ...
    def switch_to_operation_maintenance_management_info_page(self):
        ...
        self.click_element(
            OperationManagementInfoLocator.operation_management_info_page_loc
        )
    ...
    def _select_operation_maintenance_person(self, operation_maintenance_person):
        self.click_element(
            OperationManagementInfoLocator.operation_responsible_select_loc
        )
        self.random_sleep(0.5)
        if operation_maintenance_person == "":
            logger.info("未填写运维负责人，选择运维负责人为系统管理员")
            self.click_element(
                OperationManagementInfoLocator.operation_responsible_system_administrator_loc
            )
        else:
            try:
    ...
    def _get_operation_maintenance_person_tip_text(self):
        ...
        self.random_sleep(0.5)
        return self.text(
            OperationManagementInfoLocator.operation_responsible_tip_text_loc
        )
    ...
    def _fill_first_inspection_time(self, first_inspection_time):
        ...
        self.click_element(
            OperationManagementInfoLocator.first_inspection_time_select_loc
        )
        self.random_sleep(0.5)
    ...
    def _select_inspection_cycle(self, inspection_cycle):
        ...
        if inspection_cycle == "":
            ...
            self.click_element(
                OperationManagementInfoLocator.inspection_cycle_one_month_loc
            )
        else:
            try:
                logger.info(f"选择巡检周期为{inspection_cycle}")
    ...
    def _add_inspection_group(self, inspection_group):
        ...
        self.click_element(
            OperationManagementInfoLocator.add_inspection_group_button_loc
        )
        self.random_sleep(0.5)
        self.send_keys_by_clear(
            OperationManagementInfoLocator.inspection_group_name_input_loc,
            inspection_group,
        )
        self.random_sleep(0.5)
        self.click_element(
            OperationManagementInfoLocator.add_inspection_item_button_loc
        )
        self.random_sleep(0.5)
    ...
    def _click_batch_download_inspection_code_button(self):
        ...
        self.click_element(
            OperationManagementInfoLocator.batch_download_inspection_code_button_loc
        )

    # 填写运维管理信息界面数据
    def fill_operation_maintenance_management_info(
        self,
        ...
        self._select_operation_maintenance_person(
            operation_maintenance_person
        )  # 选择运维负责人
    ...
    def get_operation_maintenance_person_required_text(self):
        return self.text(
            OperationManagementInfoLocator.operation_responsible_required_text_loc
        )

    # 请选择首次巡检时间
    def get_first_inspection_time_required_text(self):
        return self.text(
            OperationManagementInfoLocator.first_inspection_time_required_text_loc
        )

    # 请选择巡检周期
    def get_inspection_cycle_required_text(self):
        return self.text(
            OperationManagementInfoLocator.inspection_cycle_required_text_loc
        )
    ...
    def search_by_project_name(self, project_name):
        ...
        self.send_keys_by_clear(
            ElectronicArchivesLocator.project_name_input_loc, project_name
        )
