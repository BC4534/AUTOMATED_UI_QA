...
class SupplierMaintenancePage(ElectronicArchivesPage):
    ...
    def supplier_maintenance_click_add_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_add_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_cancel_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_cancel_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_close_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_close_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_confirm_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_confirm_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_save_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_save_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_clear_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_clear_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_edit_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_edit_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_delete_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_delete_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_confirm_delete_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_delete_confirm_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_click_cancel_delete_button(self):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_delete_cancel_button_loc
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_input_supplier_name(self, supplier_name):
        self.send_keys_by_clear_and_typing(
            SupplierMaintenanceLocator.supplier_maintenance_supplier_name_input_loc,
            supplier_name,
        )
        self.random_sleep(0.5)
    ...
    def supplier_maintenance_select_supplier_type(self, supplier_type):
        self.click_element(
            SupplierMaintenanceLocator.supplier_maintenance_supplier_type_select_loc
        )
        self.random_sleep(0.5)
        try:
            self.click_element(
                (
                    "xpath",
                    f'//*[@title="{supplier_type}" and contains(@class,"ant-select-item ant-select-item-option")]',
                )
            )
            self.click_element(
    ...
    def supplier_maintenance_get_first_supplier_name(self):
        time.sleep(1)
        return self.text(
            SupplierMaintenanceLocator.supplier_maintenance_first_supplier_name_loc
        )

    # 获取已输入的供应商类型
    def supplier_maintenance_get_first_supplier_type(self):
        return self.text(
            SupplierMaintenanceLocator.supplier_maintenance_first_supplier_type_loc
        )
    ...
    def supplier_maintenance_get_supplier_name_required_text(self):
        return self.text(
            SupplierMaintenanceLocator.supplier_maintenance_get_supplier_name_required_loc
        )

    # 获取供应商类型是必填项  供货范围 是必填的!!
    def supplier_maintenance_get_supplier_type_required_text(self):
        return self.text(
            SupplierMaintenanceLocator.supplier_maintenance_get_supplier_type_required_loc
        )
