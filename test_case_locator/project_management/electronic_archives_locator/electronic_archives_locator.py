...
class ElectronicArchivesLocator:
    ...
    # 项目阶段选择框
    project_stage_select_loc = (By.XPATH, '//*[text()="请选择项目阶段"]/..')
    # 项目阶段 - 待实施阶段
    ...
    # 项目进度
    project_progress_select_loc = (By.XPATH, '//*[text()="请选择项目进度"]/..')
    # 项目进度 - 计划期 //*[@title="计划期"]
    project_progress_plan_period_loc = (By.XPATH, '//*[@title="计划期"]')
    # 项目进度 - 准备期 //*[@title="准备期"]
    project_progress_preparation_period_loc = (By.XPATH, '//*[@title="准备期"]')
    # 项目进度 - 发货期
    project_progress_shipping_period_loc = (By.XPATH, '//*[@title="发货期"]')
    # 项目进度 - 调试期
    project_progress_debugging_period_loc = (By.XPATH, '//*[@title="调试期"]')
    # 项目进度 - 试运行
    project_progress_testing_period_loc = (By.XPATH, '//*[@title="试运行"]')
    # 项目进度 - 质保期
    project_progress_warranty_period_loc = (By.XPATH, '//*[@title="质保期"]')
    # 项目进度 - 已过保
    project_progress_stop_period_loc = (By.XPATH, '//*[@title="已过保"]')

    # 项目类型 选择框
    project_type_select_loc = (By.XPATH, '//*[text()="请选择项目类型"]/..')
    # 项目类型 - 工商业
    ...
    # 产品类型 选择框
    product_type_select_loc = (By.XPATH, '//*[text()="请选择产品类型"]/..')
    # 产品类型 -户外柜
    ...
    # 实施负责人选择框
    implement_leader_select_loc = (By.XPATH, '//*[text()="请选择实施负责人"]/..')
    # 实施负责人 --根据名字定位
    # implementation_responsible_loc = (By.XPATH, f'//*[@title="{}"]')
    # 运维负责人
    operation_leader_select_loc = (By.XPATH, '//*[text()="请选择运维负责人"]/..')
    # 状态 选择框
    project_status_select_loc = (By.XPATH, '//*[text()="状态"]/following::div/div')
    # 状态 - 草稿
    ...
    # 第一个项目所属阶段
    first_project_stage_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[6]')
    # 第二个项目所属阶段
    second_project_stage_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[3]/td[6]')
