...
class AddProjectLocator:
    ...
    current_month_1_loc = (
        By.XPATH,
        '//div[text()="1" and @class="ant-picker-cell-inner"]',
    )
    # 下个月1号
    next_month_1_loc = (
        By.XPATH,
        '(//div[text()="1" and @class="ant-picker-cell-inner"])[2]',
    )
    """
    新增项目界面的元素
    由于元素太多了，每个页面再写一个类
    ...
    class ProjectBaseInfoLocator:
        ...
        project_time_select_loc = (
            By.XPATH,
            '//*[@title="立项时间"]/following::input[@placeholder="请选择日期"]',
        )
        # 立项时间 今天
        ...
        # 项目装机功率输入框
        project_install_power_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入项目装机功率"]',
        )
        # 项目装机容量输入框
        project_install_capacity_input_loc = (
            By.XPATH,
        ...
        project_stage_select_loc = (By.XPATH, '//*[@id="basic_phase"]/..')
        # 项目阶段 - 待实施阶段
        project_stage_wait_for_implementation_loc = (
            By.XPATH,
            '//*[@title="待实施阶段"]',
        )
        # 项目阶段 - 实施阶段
        ...
        # 户外柜文本框值
        product_type_text_loc = (
            By.XPATH,
            '//*[@id="basic_productType"]/following::span',
        )
        # 产品类型 - 非系统
        ...
        # 户外柜规格选择框
        outdoor_cabinet_type_select_loc = (
            By.XPATH,
            '//*[@id="basic_outdoorCabinetSpec"]/..',
        )
        # 215户外柜国标1.0
        outdoor_cabinet_type_215_gb1_0_loc = (
            By.XPATH,
            '//*[@title="215户外柜国标1.0"]',
        )
        # 215户外柜国标2.0
        outdoor_cabinet_type_215_gb2_0_loc = (
            By.XPATH,
            '//*[@title="215户外柜国标2.0"]',
        )
        # 232户外柜
        ...
        # 是否支持巡检标准
        # 是否支持巡检标准 - 是
        is_support_inspection_standard_yes_loc = (
            By.XPATH,
            '//*[@title="是否支持标准巡检"]/following::input[@value="true"]/..',
        )
        # 是否支持巡检标准 - 否
        is_support_inspection_standard_no_loc = (
            By.XPATH,
            '//*[@title="是否支持标准巡检"]/following::input[@value="false"]/..',
        )
        ...
        # ==============必填项填写=====================
        # 立项时间必填项
        init_time_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_approvalTime_help"]/div',
        )
        # 项目名称必填项
        project_name_required_text_loc = (By.XPATH, '//*[@id="basic_name_help"]/div')
        # 项目装机功率必填项
        project_install_power_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_maxPowerMw_help"]/div',
        )
        # 项目装机容量必填项
        project_install_capacity_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_capacityMwh_help"]/div',
        )
        # 项目阶段必填项
        project_stage_required_text_loc = (By.XPATH, '//*[@id="basic_phase_help"]/div')
        # 项目进度必填项
        project_progress_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_subPhase_help"]/div',
        )
        # 项目类型必填项
        project_type_required_text_loc = (By.XPATH, '//*[@id="basic_type_help"]/div')
        # 产品类型必填项
        product_type_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_productType_help"]/div',
        )
        # 项目区域必填项
        project_area_required_text_loc = (By.XPATH, '//*[@id="basic_region_help"]/div')
        # 是否支持巡检标准必填项
        is_support_inspection_standard_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_supportStandardInspection_help"]/div',
        )
    ...
    class ProjectDetailInfoLocator:
        ...
        # 电站联系方式
        station_contact_phone_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电站联系方式"]',
        )
        # 总包单位名称输入框
        total_package_unit_name_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入总包单位名称"]',
        )
        # 我方供货范围输入框
        our_supply_range_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入我方供货范围"]',
        )
        # 质保期起止时间
        # 质保期开始时间
        ...
        current_month_1_loc = (
            By.XPATH,
            '(//div[text()="1" and @class="ant-picker-cell-inner"])[1]',
        )
        # 下个月1号
        next_month_1_loc = (
            By.XPATH,
        ...
        # 电站内储能单元分组情况
        station_internal_storage_unit_grouping_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电站内储能单元分组情况"]',
        )
        # 电站所属省
        station_belong_province_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电站所属省"]',
        )
        # 电站所属市
        station_belong_city_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电站所属市"]',
        )
        # 电站所属区/镇
        station_belong_area_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电站所属区/镇"]',
        )
        # 经度
        ...
        # ===========设备配置信息=============
        # 电池仓数量(个)输入框
        battery_cabinet_number_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电池仓数量"]',
        )
        # 单台电池仓容量(kWh)输入框
        battery_cabinet_capacity_input_loc = (
            By.XPATH,
        ...
        # 电芯材料 - 磷酸铁锂
        battery_material_phosphor_iron_battery_loc = (
            By.XPATH,
            '//*[@title="磷酸铁锂"]',
        )
        # 电池堆成组方式输入框
        battery_grouping_method_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电池堆成组方式"]',
        )
        # 单台PCS最大功率(kW)输入框
        pcs_max_power_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入单台PCS最大功率(kW)"]',
        )
        # 电池簇组成组方式输入框
        battery_cluster_grouping_method_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电池簇成组方式"]',
        )
        # 电池模组成组方式输入框
        battery_module_grouping_method_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入电池模组成组方式"]',
        )
        # 单电芯额定容量(Ah)输入框
        single_cell_capacity_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入单电芯额定容量(Ah)"]',
        )
        # 充放电转换效率(%)输入框
        charge_discharge_efficiency_input_loc = (
            By.XPATH,
        ...
        # 额定充放电倍率(C)输入框
        rated_charge_discharge_rate_input_loc = (
            By.XPATH,
            '//*[@placeholder="请输入额定充放电倍率(C)"]',
        )
        # 关联电站信息 id="basic_sePlants"
        associated_station_information_select_loc = (
            By.XPATH,
            '//*[@id="basic_sePlants"]/..',
        )
        # 关联电站信息 文本框
        associated_station_information_text_loc = (
            By.XPATH,
            '//*[text()="关联电站信息"]',
        )
        ...
        bms_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_BMSManufacturerPhone"]',
        )
        ...
        pcs_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_PCSManufacturerPhone"]',
        )
        # 变压器厂商选择框 id="basic_transformerManufacturer"
        transformer_vendor_select_loc = (
            By.XPATH,
            '//*[@id="basic_transformerManufacturer"]/..',
        )
        # 变压器厂商联系方式输入框 id="basic_transformerManufacturerPhone"
        transformer_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_transformerManufacturerPhone"]',
        )
        # 液冷系统厂商选择框 id="basic_liquidCoolingManufacturer"
        liquid_cooling_system_vendor_select_loc = (
            By.XPATH,
            '//*[@id="basic_liquidCoolingManufacturer"]/..',
        )
        # 液冷系统厂商联系方式输入框 id="basic_liquidCoolingManufacturerPhone"
        liquid_cooling_system_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_liquidCoolingManufacturerPhone"]',
        )
        # 空调厂商选择框 id="basic_airManufacturer"
        air_conditioner_vendor_select_loc = (
            By.XPATH,
            '//*[@id="basic_airManufacturer"]/..',
        )
        # 空调厂商联系方式输入框 id="basic_airManufacturerPhone"
        air_conditioner_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_airManufacturerPhone"]',
        )
        # PACK组装厂厂商选择框 id="basic_PACKManufacturer"
        pack_assembly_vendor_select_loc = (
            By.XPATH,
            '//*[@id="basic_PACKManufacturer"]/..',
        )
        # PACK组装厂厂商联系方式输入框 id="basic_PACKManufacturerPhone"
        pack_assembly_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_PACKManufacturerPhone"]',
        )
        ...
        cell_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_cellManufacturerPhone"]',
        )
        # 电池仓箱体厂商选择框 id="basic_batteryManufacturer"
        battery_box_vendor_select_loc = (
            By.XPATH,
            '//*[@id="basic_batteryManufacturer"]/..',
        )
        # 电池仓箱体厂商联系方式输入框 id="basic_batteryManufacturerPhone"
        battery_box_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_batteryManufacturerPhone"]',
        )
        # 消防厂商选择框 id="basic_fireManufacturer"
        fire_protection_vendor_select_loc = (
            By.XPATH,
            '//*[@id="basic_fireManufacturer"]/..',
        )
        # 消防厂商联系方式输入框 id="basic_fireManufacturerPhone"
        fire_protection_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_fireManufacturerPhone"]',
        )
        ...
        ems_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_emsManufacturerPhone"]',
        )
        # 汇流柜厂商选择框 id="basic_combinerCabinetManufacturer"
        busbar_cabinet_vendor_select_loc = (
            By.XPATH,
            '//*[@id="basic_combinerCabinetManufacturer"]/..',
        )
        # 汇流柜厂商联系方式输入框 id="basic_combinerCabinetManufacturerPhone"
        busbar_cabinet_vendor_contact_phone_input_loc = (
            By.XPATH,
            '//*[@id="basic_combinerCabinetManufacturerPhone"]',
        )
        ...
        battery_box_number_required_loc = (
            By.XPATH,
            '//*[@id="basic_batterySlotCount_help"]/div',
        )
        # bms厂商 id="basic_BMSManufacturer_help"
        bms_vendor_required_loc = (
            By.XPATH,
            '//*[@id="basic_BMSManufacturer_help"]/div',
        )

    # =====================实施维护管理信息=====================
    class ImplementationMaintenanceInfoLocator:
        # // *[text() = "维护实施管理信息"]维护实施管理信息
        maintain_implement_info_management_page_loc = (
            By.XPATH,
            '//*[text() = "维护实施管理信息"]',
        )
        # 实施计划时间选择框 id="basic_implementationPlanTime"
        implementation_plan_time_loc = (
            By.XPATH,
            '//*[@id="basic_implementationPlanTime"]/..',
        )

        # 实施负责人选择框 id="basic_implementManagerAccount"
        implementation_responsible_select_loc = (
            By.XPATH,
            '//*[@id="basic_implementManagerAccount"]/..',
        )
        # 实施负责人 - 系统管理员
        implementation_responsible_system_administrator_loc = (
            By.XPATH,
            '//*[@class="rc-virtual-list-holder-inner"]/div[@title="系统管理员"]',
        )

        # 实施负责人后面的（！）
        implementation_responsible_tip_loc = (By.XPATH, '//*[text()="实施负责人"]')
        # 实施负责人！的提示文本
        implementation_responsible_tip_text_loc = (
            By.XPATH,
            '//*[text()="创建项目后，会在计划开始时间时自动创建一条实施工单至实施负责人，实施阶段该项目 产生的所有工单会由实施负责人负责。"]',
        )

        # ===============必填项
        # 请输入实施计划时间 id="basic_implementationPlanTime_help"
        implementation_plan_time_required_loc = (
            By.XPATH,
            '//*[@id="basic_implementationPlanTime_help"]/div',
        )
        # 请选择实施负责人
        implementation_responsible_required_loc = (
            By.XPATH,
            '//*[text()="请选择实施负责人"]',
        )
    ...
    class OperationManagementInfoLocator:
        ...
        operation_responsible_select_loc = (
            By.XPATH,
            '//*[@id="basic_operationsManagerAccount"]/..',
        )
        # 运维负责人 - 系统管理员
        operation_responsible_system_administrator_loc = (
            By.XPATH,
            '//*[@class="rc-virtual-list-holder-inner"]/div[@title="系统管理员"]',
        )
        # 运维负责人后面的（！）
        ...
        # 运维负责人！的提示文本
        operation_responsible_tip_text_loc = (
            By.XPATH,
            '//*[text()="创建项目后，实施阶段该项目产生的所有工单将由实施负责人处理。"]',
        )
        # 首次巡检时间选择框 id="basic_firstInspectionDate
        first_inspection_time_select_loc = (
            By.XPATH,
            '//*[@id="basic_firstInspectionDate"]/..',
        )
        # 今天
        ...
        # 输入巡检组名
        inspection_group_name_input_loc = (
            By.XPATH,
            '//*[@id="basic_inspectionGroups_0_nameLabel"]',
        )
        ...
        inspection_item_select_loc = (
            By.XPATH,
            '//*[@id="basic_inspectionGroups_0_inspectionTeamGroup_0_inspectionItemIds"]/..',
        )

        # 第一个巡检项
        inspection_item_one_loc = (
            By.XPATH,
            '(//*[@class="rc-virtual-list-holder-inner"])[3]/div/div',
        )

        # 批量下载巡检编码按钮
        batch_download_inspection_code_button_loc = (
            By.XPATH,
            '//*[text()="批量下载巡检编码"]/..',
        )
        ...
        operation_responsible_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_operationsManagerAccount_help"]/div',
        )
        # 请选择首次巡检时间 id="basic_firstInspectionDate_help"
        first_inspection_time_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_firstInspectionDate_help"]/div',
        )
        # 请选择巡检周期 id="basic_inspectionCycle_help"
        inspection_cycle_required_text_loc = (
            By.XPATH,
            '//*[@id="basic_inspectionCycle_help"]/div',
        )
...
ImplementationMaintenanceInfoLocator = (
    AddProjectLocator().ImplementationMaintenanceInfoLocator()
)
