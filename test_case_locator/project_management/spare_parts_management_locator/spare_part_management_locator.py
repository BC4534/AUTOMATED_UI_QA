...
class SparePartManagementLocator():
    ...
    first_spare_part_checkbox_loc = (By.XPATH, '(//*[@class="ant-checkbox-input"])[2]/..')
    # 第二个备件复选框
    second_spare_part_checkbox_loc = (By.XPATH, '(//*[@class="ant-checkbox-input"])[3]/..')


    # 第一个备件数量字段 //*[@class="ant-table-tbody"]/tr[2]/td[3]
    first_spare_part_number_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[4]')
    # 第二个备件数量字段
    second_spare_part_number_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[3]/td[4]')
    # 第三个备件数量字段
    third_spare_part_number_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[4]/td[4]')
    ...
    search_spare_part_type_first_option_loc = (By.XPATH, '//*[@class="rc-virtual-list-holder-inner"]/div')
    # 第一个备件的备件类型字段 //*[@class="ant-table-tbody"]/tr[2]/td[5]
    fitst_spare_part_type_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[5]')
    # 第二个备件类型
    second_spare_part_type_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[3]/td[5]')

    # 所属仓库选择框
    search_spare_part_warehouse_select_loc = (By.XPATH, '//*[text()="请选择所属仓库"]/..')
    # 上海仓
    search_spare_part_warehouse_shanghai_loc = (By.XPATH, '//*[@title="上海备品仓" and @aria-selected]')
    # 宁夏仓
    search_spare_part_warehouse_ningxia_loc = (By.XPATH, '//*[@title="宁夏备品仓" and @aria-selected]')
    # 第一个备件的所属仓库
    first_spare_part_warehouse_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[6]')

    # 查询条件 ：备件属性选择框
    search_spare_part_attribute_select_loc = (By.XPATH, '//*[text()="请选择备件属性"]/..')
    # 备件属性 选择1 供应商预存备件
    search_spare_part_attribute_supplier_pre_spare_part_loc = (By.XPATH, '//*[@title="供应商预存备件" and @aria-selected]')
    # 备件属性 选择2 采日自采备件
    search_spare_part_attribute_self_purchase_spare_part_loc = (By.XPATH, '//*[@title="采日自采备件" and @aria-selected]')
    # 备件属性 选择3 采日自研备件
    search_spare_part_attribute_self_develop_spare_part_loc = (By.XPATH, '//*[@title="采日自研备件" and @aria-selected]')

    # 第一个备件的备件属性字段
    first_spare_part_attribute_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[7]')
    # 第二个备件的备件属性字段
    second_spare_part_attribute_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[3]/td[7]')


    # 所属供应商选择框
    search_spare_part_supplier_select_loc = (By.XPATH, '//*[text()="请选择所属供应商"]/..')
    # 所属供应商第一个选项
    # search_spare_part_supplier_first_option_loc = (By.XPATH, '(//*[@class="rc-virtual-list-holder-inner"])[4]/div/div')
    search_spare_part_supplier_first_option_loc = (By.XPATH, '//*[@class="ant-select-item-option-content" and text()]/..')
    # first_spare_part_supplier_text_loc
    # 备件供应商字段
    first_spare_part_supplier_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[8]')
    # 第二个备件供应商字段
    second_spare_part_supplier_text_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[3]/td[8]')
    ...
    # 第一个备件名称选项
    first_spare_part_name_option_loc = (By.XPATH, '//*[@class="rc-virtual-list-holder-inner"]/div')
    ...
    # 第二个备件名称
    second_spare_part_name_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[3]/td[2]/div')

    # 页面提示信息元素
    page_tip_loc = (By.XPATH, '//*[@class="ant-message-notice-content"]/div/span[last()]')

    # 第一个备件的查看出入库记录按钮  //*[text()="查看出入库记录"]/..
    first_spare_part_view_inbound_record_button_loc = (By.XPATH, '//*[text()="查看出入库记录"]/..')

    # 出入库记录页面的title //*[ @class="ant-drawer-title" and text()="出入库记录"]
    spare_part_inbound_record_title_loc = (By.XPATH, '//*[ @class="ant-drawer-title" and text()="出入库记录"]')
    # 出入库记录页面的关闭按钮 //*[@class="ant-drawer-close"]
    spare_part_inbound_record_close_button_loc = (By.XPATH, '//*[@class="ant-drawer-close"]')
    ...
    spare_part_receive_title_loc = (By.XPATH, '//*[ @class="ant-modal-title" and text()="备件领用"]')
    ...
    spare_part_receive_project_first_option_loc = (By.XPATH, '//*[@class="rc-virtual-list-holder-inner"]/div')
    # 备件领用备注输入框 id="remark"
