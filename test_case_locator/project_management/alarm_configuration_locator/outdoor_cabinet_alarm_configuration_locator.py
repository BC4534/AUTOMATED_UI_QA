...
class OutdoorCabinetAlarmConfigurationLocator:
    ...
    # 编辑界面 - 运维告警类型
    edit_operation_alarm_type_select_loc = (
        By.XPATH,
        '//*[@title="运维告警类型"]/following::div[@class="ant-select-selector"]',
    )
    # 运维告警类型必填提示信息 //*[@id="mmsEventClassify_help"]/div
    edit_operation_alarm_type_required_message_loc = (
        By.XPATH,
        '//*[@id="mmsEventClassify_help"]/div',
    )
    # 告警类型 内容
    edit_operation_alarm_type_content_loc = (
        By.XPATH,
        '//*[@title="运维告警类型"]/following::span[@class="ant-select-selection-item"]',
    )
    # 告警类型 -EMS
    ...
    # 告警类型-液冷系统
    edit_operation_alarm_type_liquid_cooling_system_loc = (
        By.XPATH,
        '//*[@title="液冷系统"]',
    )
    # 告警类型-消防系统
    ...
    # 运维告警等级
    edit_operation_alarm_level_select_loc = (
        By.XPATH,
        '//*[@title="运维告警等级"]/following::div[@class="ant-select-selector"]',
    )
    # 告警等级 一级
    ...
    edit_is_alarm_yes_radio_loc = (
        By.XPATH,
        '//*[@class="ant-radio-input" and @value="true"]',
    )

    # 是否告警-否//*[@class="ant-radio-input" and @value="false"]
    edit_is_alarm_no_radio_loc = (
        By.XPATH,
        '//*[@class="ant-radio-input" and @value="false"]',
    )

    # 是否自动生成工单 是
    edit_is_auto_generate_work_order_yes_radio_loc = (
        By.XPATH,
        '(//*[@class="ant-radio-input" and @value="true"])[2]',
    )
    # 是否自动生成工单 否
    edit_is_auto_generate_work_order_no_radio_loc = (
        By.XPATH,
        '(//*[@class="ant-radio-input" and @value="false"])[2]',
    )

    # 查询相关 =============================================================================================
    # 第一个告警的设备名称  //*[@class="ant-table-body"]//tr[2]/td
    first_alarm_device_name_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[2]/td[1]',
    )
    # 第二个告警的设备名称
    second_alarm_device_name_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[3]/td[1]',
    )
    # 第一个告警的户外柜规格
    first_alarm_outdoor_cabinet_specification_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[2]/td[2]',
    )
    # 第二个告警的户外柜规格
    second_alarm_outdoor_cabinet_specification_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[3]/td[2]',
    )
    # 第一个告警的告警名称
    first_alarm_alarm_name_loc = (By.XPATH, '//*[@class="ant-table-body"]//tr[2]/td[3]')
    # 第二个告警的告警名称
    second_alarm_alarm_name_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[3]/td[3]',
    )
    # 第一个告警的告警描述
    first_alarm_alarm_description_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[2]/td[5]',
    )
    # 第二个告警的告警描述
    second_alarm_alarm_description_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[3]/td[5]',
    )
    # 第一个告警的告警类型
    first_alarm_alarm_type_loc = (By.XPATH, '//*[@class="ant-table-body"]//tr[2]/td[6]')
    # 第二个告警的告警类型
    second_alarm_alarm_type_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[3]/td[6]',
    )
    # 第一个告警的告警等级
    first_alarm_alarm_level_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[2]/td[7]',
    )
    # 第二个告警的告警等级
    second_alarm_alarm_level_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[3]/td[7]',
    )
    # 第一个告警的告警是否自动生成工单
    first_alarm_is_auto_create_work_order_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[2]/td[9]',
    )
    # 第一个告警的最后修改人
    first_alarm_last_modifier_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[2]/td[10]',
    )
    # 第二个告警的最后修改人
    second_alarm_last_modifier_loc = (
        By.XPATH,
        '//*[@class="ant-table-body"]//tr[3]/td[10]',
    )
    # 第一个是否告警
    ...
    # 户外柜规格选择框
    search_outdoor_cabinet_specification_select_loc = (
        By.XPATH,
        '//*[text()="请选择户外柜规格"]/..',
    )
    # 户外柜规格 215户外柜国标1.0 //*[@title="215户外柜国标1.0"]
    search_outdoor_cabinet_specification_215_1_loc = (
        By.XPATH,
        '//*[@title="215户外柜国标1.0"]',
    )
    # 户外柜规格 215户外柜国标2.0 //*[@title="215户外柜国标2.0"]
    search_outdoor_cabinet_specification_215_2_loc = (
        By.XPATH,
        '//*[@title="215户外柜国标2.0"]',
    )
    # 户外柜规格 232户外柜
    ...
    # 告警描述查询条件输入框
    search_alarm_description_input_loc = (
        By.XPATH,
        '//*[@placeholder="请输入运维告警描述"]',
    )
    # 运维告警类型选择框
    ...
    # 是否自动生成工单 选择框
    search_is_auto_create_work_order_select_loc = (
        By.XPATH,
        '//*[text()="请选择是否自动生成工单"]/..',
    )
    # 是否自动生成工单-是
