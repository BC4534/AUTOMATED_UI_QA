...
class ManagementRoleLocator():
    ...
    # 在途异常工单 数量
    abnormal_work_order_number_loc = (By.XPATH, '//*[@title="在途异常工单"]/following-sibling::a')
    # 在途其他工单
    abnormal_other_work_order_loc = (By.XPATH, '//*[text()="在途其他工单"]')
    # 在途其他工单 数量
    abnormal_other_work_order_number_loc = (By.XPATH, '//*[@title="在途其他工单"]/following-sibling::a')
    # 发起工单数
    initiate_work_order_loc = (By.XPATH, '//*[text()="发起工单数"]')
    # 发起工单数 数量
    initiate_work_order_number_loc = (By.XPATH, '//*[@title="发起工单数"]/following-sibling::a')
    # 已执行总数
    executed_work_order_loc = (By.XPATH, '//*[text()="已执行工单总数"]')
    # 已执行总数 数量
    executed_work_order_number_loc = (By.XPATH, '//*[@title="已执行总数"]/following-sibling::a')
    # 待执行工单数
    pending_work_order_loc = (By.XPATH, '//*[text()="待执行工单数"]')
    # 待执行工单数 数量
    pending_work_order_number_loc = (By.XPATH, '//*[@title="待执行工单总数"]/following-sibling::a')
    # 待执行异常工单
    pending_abnormal_work_order_loc = (By.XPATH, '//*[text()="待执行异常工单"]')
    # 待执行异常工单 数量
    pending_abnormal_work_order_number_loc = (By.XPATH, '//*[@title="待执行异常工单"]/following-sibling::a')
    ...
    # 时间维度 年
    time_dimension_year_loc = (By.XPATH, '//*[text()="年" and @class="ant-select-item-option-content"]')
    # 时间维度 月
    time_dimension_month_loc = (By.XPATH, '//*[text()="月" and @class="ant-select-item-option-content"]')
