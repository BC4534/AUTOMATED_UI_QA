...
class WorkOrderListLocator:
    ...
    # 工单发起人 系统管理员
    initiator_of_work_order_system_administrator_loc = (
        By.XPATH,
        '//*[@title="系统管理员"]',
    )
    ...
    # 后一年按钮
    next_year_button_loc = (
        By.XPATH,
        '(//*[@class="ant-picker-header-super-next-btn"])[2]',
    )
    # 计划开始时间 后一年按钮
    plan_time_next_year_button_loc = (
        By.XPATH,
    ...
    # 计划开始时间后一个月按钮
    plan_time_next_month_button_loc = (
        By.XPATH,
        '(//*[@class="ant-picker-header-next-btn"])',
    )
    # 当前开始时间页 1号按钮
    start_time_1_button_loc = (
        By.XPATH,
        '//*[@class="ant-picker-cell ant-picker-cell-in-view"]/div[text()="1"]',
    )
    # 开始时间页面，28号按钮
    start_time_28_button_loc = (
        By.XPATH,
        '//*[@class="ant-picker-cell ant-picker-cell-in-view"]/div[text()="28"]',
    )

    # 结束页面 1号按钮
    end_time_1_button_loc = (
        By.XPATH,
        '(//*[@class="ant-picker-cell ant-picker-cell-in-view"]/div[text()="1"])[2]',
    )
    # 结束页面 28号按钮
    end_time_28_button_loc = (
        By.XPATH,
        '(//*[@class="ant-picker-cell ant-picker-cell-in-view"]/div[text()="28"])[2]',
    )

    # 发布时间的时间页面展开/清除已填时间 loc
    clear_time_button_loc = (By.XPATH, '//*[@fill-rule="evenodd"]')
    # 发布时间展开
    publish_time_expand_button_loc = (
        By.XPATH,
        '//*[text()="发布时间："]/following-sibling::div',
    )

    # 处理状态 选择框
    handle_status_select_loc = (
        By.XPATH,
    ...
    handle_status_finished_loc = (
        By.XPATH,
        '//*[text()="已完成" and @class="ant-select-item-option-content"]',
    )

    # 工单编号输入框
    work_order_number_input_loc = (
        By.XPATH,
        '//*[text()="工单编号"]/following-sibling::span/input',
    )
    # 搜索查询界面 工单名称输入框
    select_work_order_name_input_loc = (
        By.XPATH,
        '//*[text()="工单名称"]/following-sibling::span/input',
    )
    # 搜索界面，关联项目选择框
    select_association_project_select_loc = (
        By.XPATH,
        '//*[text()="关联项目"]/following-sibling::div/div/span',
    )
    # 搜索界面，关联项目文本
    ...
    association_project_first_option_loc = (
        By.XPATH,
        '(//*[@class="ant-select-item-option-content"])[3]',
    )
    # 搜计划开始时间按钮
    plan_start_time_button_loc = (
        By.XPATH,
        '//*[text()="计划开始时间："]/following-sibling::div/div/input',
    )
    # 工作所属区域选择框
    work_area_select_loc = (
        By.XPATH,
        '//*[text()="工单所属区域"]/following-sibling::div/div/span',
    )
    # 工单发起人选择框
    initiator_select_loc = (
        By.XPATH,
        '//*[text()="工单发起人"]/following-sibling::div/div/span',
    )
    # 工单发起人 第二个选项 //*[@id="rc_select_12_list"]/following::div[@aria-selected][2]
    initiator_second_option_loc = (
        By.XPATH,
        '//*[@id="rc_select_12_list"]/following::div[@aria-selected][2]',
    )
    # 系统管理员 选项
    ...
    receiver_select_loc = (
        By.XPATH,
        '//*[text()="工单接收人"]/following-sibling::div/div/span',
    )
    # 工单当前处理人选择框
    current_processor_select_loc = (
        By.XPATH,
        '//*[text()="当前处理人"]/following-sibling::div/div/span',
    )
    # 搜索按钮
    ...
    # 搜索 计划结束时间
    plan_end_time_button_loc = (
        By.XPATH,
        '//*[text()="计划结束时间："]/following-sibling::div/div/input',
    )
    # 手工新增工单按钮
    ...
    #  关联项目选择框
    association_project_select_loc = (
        By.XPATH,
        '(//*[@class="ant-select-selector"])[9]',
    )
    # 关联项目 第一个项目
    association_project_first_loc = (
        By.XPATH,
        '(//*[@class="rc-virtual-list-holder-inner"])[2]/div',
    )
    # 负责人选择框
    responsible_person_select_loc = (
        By.XPATH,
        '(//*[@class="ant-select-selector"])[10]',
    )
    # 负责人 第一个负责人 系统管理员
    responsible_person_first_loc = (
        By.XPATH,
        '(//*[@class="rc-virtual-list-holder-inner"])[3]/div',
    )
    # 计划开始时间
    ...
    # 必填项效验相关元素
    # 工单类型必填项提示
    work_order_type_required_loc = (
        By.XPATH,
        '//*[@class="ant-form-item-explain-error"]',
    )
    # 工单名称必填项提示
    work_order_name_required_loc = (
        By.XPATH,
        '(//*[@class="ant-form-item-explain-error"])[2]',
    )
    # 工单描述必填项提示
    work_order_description_required_loc = (
        By.XPATH,
        '(//*[@class="ant-form-item-explain-error"])[3]',
    )
    # 关联项目必填项提示
    association_project_required_loc = (
        By.XPATH,
        '(//*[@class="ant-form-item-explain-error"])[4]',
    )
    # 负责人必填项提示
    responsible_person_required_loc = (
        By.XPATH,
        '(//*[@class="ant-form-item-explain-error"])[5]',
    )
    # 计划开始时间必填项提示
    plan_start_time_required_loc = (
        By.XPATH,
        '(//*[@class="ant-form-item-explain-error"])[6]',
    )
    # 计划结束时间必填项提示
    plan_end_time_required_loc = (
        By.XPATH,
        '(//*[@class="ant-form-item-explain-error"])[7]',
    )
    ...
    # 未选中状态 第2条数据复选框
    second_data_checkbox_loc = (
        By.XPATH,
        '(//*[@class="ant-checkbox ant-wave-target css-1hzb5nd"])[2]',
    )
    # 未选中状态 第1条数据复选框
    first_data_checkbox_loc = (
        By.XPATH,
        '(//*[@class="ant-checkbox ant-wave-target css-1hzb5nd"])',
    )

    # 界面提示弹窗
    page_tip_loc = (By.XPATH, '//*[@class="ant-message-notice-content"]/div/span[2]')
    # 第一条工单编号
    first_work_order_number_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[1]',
    )
    # 第二个工单编号
    second_work_order_number_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[1]',
    )
    # 第一条数据的详情按钮
    ...
    # 第一条数据的工单名称文本
    first_data_work_order_name_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[2]',
    )
    # 第二条数据的工单名称文本
    second_data_work_order_name_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[2]',
    )
    # 第一条数据的处理状态文本
    first_data_handle_status_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[3]/span',
    )
    # 第一条数据的发布时间
    first_data_publish_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-row ant-table-row-level-0"]/td[5]',
    )
    # 第一条数据的关联项目
    first_data_association_project_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[5]',
    )
    # 第二条数据的关联项目
    second_data_association_project_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[5]',
    )
    # 第一条数据的工单类型
    first_data_work_order_type_loc = (
        By.XPATH,
    ...
    # 第一条数据的计划开始时间
    first_data_plan_start_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[8]',
    )
    # 第二条数据的计划开始时间
    second_data_plan_start_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[8]',
    )
    # 第一条数据的计划结束时间
    first_data_plan_end_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[9]',
    )
    # 第二条数据的计划结束时间
    second_data_plan_end_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[9]',
    )
    # 第一条数据的工单发起人
    first_data_initiator_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[10]')
    # 第一条数据的工单接受人
    first_data_responsible_person_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[11]',
    )
    # 第一条数据的当前处理人
    first_data_current_handler_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[12]',
    )
    # 第一条数据的实际处理人
    first_data_actual_handler_loc = (
        By.XPATH,
        '//*[@class="ant-table-row ant-table-row-level-0"]/td[14]',
    )
    # 第一条工单那的删除按钮 //*[text()="删除"]/..
