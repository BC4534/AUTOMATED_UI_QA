...
class AbnormalDetailsLocator:
    ...
    # 关联工单类型
    relation_work_order_type_select_loc = (
        By.XPATH,
        '(//*[@class="ant-select-selector"])[2]',
    )
    # 异常部件下拉框
    ...
    # 异常处理人 下拉框
    abnormal_processing_person_select_loc = (
        By.XPATH,
        '(//*[@class="ant-select-selector"])[6]',
    )
    ...
    abnormal_statistic_expand_button_loc = (
        By.XPATH,
        '//*[@class="upDownIcon___xrlxN"]',
    )
    # 是否展开判断元素 //*[@class="upDownIcon___xrlxN"]/preceding-sibling::*
    abnormal_statistic_expand_button_judge_loc = (
        By.XPATH,
        '//*[@class="upDownIcon___xrlxN"]/preceding-sibling::*',
    )
    ...
    # 第一个工单的异常名称
    first_work_order_abnormal_name_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[2]',
    )
    # 第二个工单的异常名称
    second_work_order_abnormal_name_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[2]',
    )

    # 第一个工单关联项目
    first_work_order_relation_project_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[5]',
    )
    # 第二个工单关联项目
    second_work_order_relation_project_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[5]',
    )

    # 第一个工单的关联工单类型
    first_work_order_relation_work_order_type_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[6]',
    )

    # 第一个工单的异常部件
    first_work_order_abnormal_part_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[6]',
    )
    # 第二个工单的异常部件
    second_work_order_abnormal_part_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[6]',
    )

    # 第一个工单的责任厂商
    first_work_order_responsible_vendor_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[7]',
    )

    # 第二个工单的责任厂商
    second_work_order_responsible_vendor_loc = (
        By.XPATH,
    ...
    is_purchase_loc = (
        By.XPATH,
        '//*[text()="是否领用/采购备件或耗材"]/following::span',
    )
    # 详情界面的X按钮
    detail_close_button_loc = (By.XPATH, '(//*[@fill-rule="evenodd"])[last()]')

    # 第一个工单的异常处理人
    first_work_order_abnormal_processing_person_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[20]',
    )
    # 第二个工单的异常处理人
    second_work_order_abnormal_processing_person_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[20]',
    )
