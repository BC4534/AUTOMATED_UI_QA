...
class MyAlreadyDoLocator():
    ...
    # 工单接收人选择框
    work_order_receiver_select_loc = (By.XPATH, '//*[text()="工单接收人"]/following::div')
    # 当前处理人选择框
    current_handler_select_loc = (By.XPATH, '//*[text()="当前处理人"]/following::div')

    # 第一个工单的工单接收人
    first_work_order_receiver_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[11]')
    # 第一个工单的当前处理人
    first_work_order_current_handler_loc = (By.XPATH, '//*[@class="ant-table-tbody"]/tr[2]/td[12]')
