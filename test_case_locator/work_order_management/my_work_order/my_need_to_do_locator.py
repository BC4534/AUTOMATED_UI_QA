...
class MyNeedToDoLocator:
    ...
    # 第一个工单的关联项目
    first_work_order_association_project_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[5]',
    )
    # 第一个工单的关联项目
    second_work_order_association_project_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[5]',
    )
    # 第一个工单的计划开始时间
    first_work_order_plan_start_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[8]',
    )
    # 第一个工单的计划结束时间
    first_work_order_plan_end_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[9]',
    )
    # 第二个工单的计划开始时间
    second_work_order_plan_start_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[8]',
    )
    # 第二个工单的计划结束时间
    second_work_order_plan_end_time_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[3]/td[9]',
    )
    # 第一个工单的所属区域
    first_work_order_belong_area_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[7]',
    )
    # 第一个工单发起人
    first_work_order_initiator_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[2]/td[10]',
    )
