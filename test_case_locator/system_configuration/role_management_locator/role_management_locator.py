...
class RoleManagementLocator:
    ...
    # 确认批量删除
    confirm_batch_delete_button_loc = (
        By.XPATH,
        '//*[@class="ant-modal-confirm-btns"]/button/span[text()="确 定"]/..',
    )
    # 取消批量删除
    cancel_batch_delete_button_loc = (
        By.XPATH,
        '//*[@class="ant-modal-confirm-btns"]/button/span[text()="取 消"]/..',
    )
    ...
    # 权限配置 选择框
    # 运维工作台权限
    permission_config_operation_loc = (
        By.XPATH,
        '//*[@class="ant-tree-checkbox-inner"]',
    )
    # 工单管理权限
    permission_config_work_order_loc = (
        By.XPATH,
        '(//*[@class="ant-tree-checkbox-inner"])[2]',
    )
    # 项目管理权限
    permission_config_project_loc = (
        By.XPATH,
        '(//*[@class="ant-tree-checkbox-inner"])[3]',
    )
    # 运维工具权限
    permission_config_tool_loc = (
        By.XPATH,
        '(//*[@class="ant-tree-checkbox-inner"])[4]',
    )
    # 知识库权限
    permission_config_knowledge_loc = (
        By.XPATH,
        '(//*[@class="ant-tree-checkbox-inner"])[5]',
    )
    # 系统配置权限
    permission_config_system_loc = (
        By.XPATH,
        '(//*[@class="ant-tree-checkbox-inner"])[6]',
    )
    ...
    # 第一个角色复选框
    first_role_checkbox_loc = (
        By.XPATH,
        '//*[@class="ant-table-tbody"]/tr[1]/td[1]//span',
    )
    # 第一个角色名称
    first_role_name_loc = (
        By.XPATH,
    ...
    page_name_loc = (
        By.XPATH,
        '//*[@style="font-size: 20px; font-family: PingFangSemiblod;"]',
    )
